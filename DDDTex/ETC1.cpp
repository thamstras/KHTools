// SOURCE: https://github.com/xdanieldzd/ETC1Lib/blob/master/ETC1Lib/ETC1.cpp
// LICENSE: https://github.com/xdanieldzd/ETC1Lib/blob/master/LICENSE.md
				...
				for(z = 0; z < 4; z++)
				{
					...
					for(x = xImage + xStart; x < xImage + xStart + 4; x++)
						for(y = yImage + yStart; y < yImage + yStart + 4; y++)
							buffer[(x * height) + y] |= (*(ptr++) & 0x00FFFFFF);
				}
			}
			else
			{
